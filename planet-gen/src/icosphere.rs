...
const original_vertices: Vec<Vector3<f32>> =
vec![
...
const original_triangles: Vec<[usize; 3]> =
vec![
...
fn vertex_for_edge(lookup: HashMap<(usize, usize), usize>, vertices: Vec<Vector3<f32>>, first: usize, second: usize) -> usize {
...
fn subdivide(vertices: Vec<Vector3<f32>>, triangles: Vec<[usize; 3]>) -> Vec<[usize; 3]> {
