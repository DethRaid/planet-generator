...
impl PlanetElement {
    fn spawn_data(element : PlanetElement) -> ElementSpawnData {
        match element {
            ...
            PlanetElement::Water => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Helium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Lithium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Carbon => (),oElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere)h
            PlanetElement::CarbonDioxide => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::CarbonMonoxide => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Methane => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Ammonia => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            ...
            PlanetElement::Sodiun => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Magnesium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Aluminum => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Silica => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Phosphorous => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Sulfur => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::SulfurDioxide => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Chlorine => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Argon => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Calcium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Titanium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Chromium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Iron => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Cobalt => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Nickel => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Copper => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Zinc => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Boromine => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Silver => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Iodine => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Tungstein => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Platinum => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Gold => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Mercury => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Lead => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Radon => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Thorium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Uranium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
            PlanetElement::Plutonium => ElementSpawnData::new(0.8, ElementSpawnLocation::Atmosphere),
        }
    }
}
