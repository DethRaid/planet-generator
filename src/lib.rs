/*!
 * \brief A planet that gets procedurally generated
 *
 ...
 * more colorful flota and fauna, colors get more muted near the poles. None of this "the whole planet is a single 
